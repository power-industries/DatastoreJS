...
class Datastore {
	constructor(adapter,
		...
		this._events = {
			onLoad: new EventManager(),
			onWrite: new EventManager(),
			onAutoWrite: new EventManager(),
			onIntegrity: new EventManager(),
			onInsert: new EventManager(),
			onFind: new EventManager(),
			onUpdate: new EventManager(),
			onDelete: new EventManager(),
		};
	}
